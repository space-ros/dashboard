...
export class IndexStore {
    ...
    resultTableStoreByKind      = new ResultTableStore('Kind', result => result.kind,        this, this, this.selection)
...
export async function postSelectArtifact(result: Result, ploc?: PhysicalLocation) {
    ...
    await vscode.postMessage({ command: 'select', logUri, uri: uriContent ?? uri, region :{startLine: region?.startLine} });
}
